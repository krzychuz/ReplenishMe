...
<p><span id="_Toc503991804" class="anchor"></span>Rysunek 4 - MRP lista produktu 3, Źródło: Opracowanie własne</p>
...
<p>Na opisanym w tym rozdziale modelu prowadzone będą wszystkie badania, jednak nie oznacza to w żadnym wypadku, że stworzona aplikacja posiada ten model twardo zapisany w kodzie.<br />
...
<p><span class="chart">[CHART]</span></p>
<p><span id="_Toc503991811" class="anchor"></span>Rysunek 11 - Shipments vs. forecast, zamówienia składane zgodnie z prognozą sprzedaży, Źródło: Opracowanie własne</p>
...
<p><span id="_Toc503693206" class="anchor"></span>Tabela 3 – Zestawienie wskaźników, zamówienia składane zgodnie z prognozą sprzedaży, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
...
<p><span class="chart">[CHART]</span></p>
<p><span id="_Toc503991812" class="anchor"></span>Rysunek 12 – Wykres HIT, zamówienia składane zgodnie z prognozą sprzedaży, Źródło: Opracowanie własne</p>
...
<p>Reasumując – przewidywalność wysyłek sprawia, że planowanie produkcji i dystrybucji nie nastręcza żadnych problemów, a łańcuch dostaw łatwo jest kontrolować. W przypadku wysokiej dokładności prognoz sprzedaży łatwo jest również dokonać optymalizacji progu replenishmentu,<br />
co skutecznie zmniejsza ilość gotówki, która dla przedsiębiorstwa zamrożona jest w towarze.</p>
...
<p><span id="_Toc503693207" class="anchor"></span>Tabela 4 - Zestawienie wskaźników, zamówienia składane poniżej prognozy sprzedaży, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
<th><strong>OFR</strong></th>
...
<p><span id="_Toc503693208" class="anchor"></span>Tabela 5 - Zestawienie wskaźników, zamówienia składane powyżej prognozy sprzedaży, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
<th><strong>OFR</strong></th>
...
<p>Kolejnym negatywnym skutkiem jest również to, że klienci, którzy doświadczyli oddziaływania braku dostępności produktu mogą próbować zabezpieczyć się na takie sytuacje w przyszłości. Kiedy więc towar stanie się powtórnie dostępny, składać będą wyższe zamówienia, by zbudować bufor bezpieczeństwa po stronie swojego zapasu. To zaś skutkuje jeszcze wyższymi zamówieniami,<br />
co przedłuża okres destabilizacji łańcucha dostaw po stronie dostawcy.</p>
<p><span class="chart">[CHART]</span></p>
<p><span id="_Toc503991814" class="anchor"></span>Rysunek 14 - Wykres HIT, zamówienia składane powyżej prognozy sprzedaży, Źródło: Opracowanie własne</p>
...
<p>Podobnie jak wiele innych systemów, linia produkcyjna wraz z załogą techników, którzy ją obsługują przemierzają drogę, którą określa krzywej nauki<a href="#fn41" class="footnote-ref" id="fnref41"><sup>41</sup></a>. Na końcu tej drogi osiągane są minimalne czasy zmian automatyki, najniższy procent odpadów produkcyjnych, a także najwyższa wydajność maksymalna linii. Jednak nawet w takim przypadku istnieje potrzeba określania minimalnego wolumenu produkcji, zależnego od rodzaju produktu. Jest to niezbędny element kontroli kosztów,<br />
bez którego nie może obyć się żadne przedsiębiorstwo. Oczywiście wolumeny te będę różnić się w zależności od produktów, technologii wytwarzania, czy samych linii produkcyjnych. Celem niniejszej pracy jest jednak określenie, jak duży wpływ ma minimalny wolumen produkcji wpływa na łańcuch dostaw.</p>
<p>Wyniki dla wszystkich przypadków omówionych w rozdziale 4.3.1. oparte były o założenie,<br />
że produkcja podejmowana jest, gdy zapotrzebowania przekraczają zdefiniowaną jednostkę zaokrąglenia, jedną paletę. W tym rozdziale zostaną zbadane dwa znacząco różne przypadki,<br />
gdy jednostka zaokrąglenia wynosi odpowiednio 3 palety i 10 palet.</p>
...
Uwagę zwrócić należy jednak na wskaźnik DFC, który spadł do poziomu 5,59 dnia. Wprowadzenie bardziej rygorystycznych wymagań w stosunku do produkcji przekłada się zatem bezpośrednio na przeciętne pokrycie materiałowe w magazynie.</p>
<p><span id="_Toc503693209" class="anchor"></span>Tabela 6 - Zestawienie wskaźników, niski minimalny wolumen produkcji, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
<th><strong>OFR</strong></th>
...
<p><span class="chart">[CHART]</span></p>
<p><span id="_Toc503991815" class="anchor"></span>Rysunek 15 - Wykres HIT, niski minimalny wolumen produkcji, Źródło: Opracowanie własne</p>
...
<p><span id="_Toc503693210" class="anchor"></span>Tabela 7 - Zestawienie wskaźników, wysoki minimalny wolumen produkcji, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
<th><strong>OFR</strong></th>
...
<p>Ze scenariusza tego można wyciągnąć kilka wniosków. Po pierwsze – w przypadku (przeciętnie) tygodniowego cyklu produkcyjnego, próg replenishmentu zdefiniowany na poziomie 8 dni jest zdecydowanie zbyt niski. Pragnąc zabezpieczyć się przez niepożądanymi skutkami cyklicznej produkcji należy (biorąc pod uwagę średni czas dostawy) ustalić parametry bezpieczeństwa tak,<br />
by kompensowały one brak dostaw, kiedy są one w idealnym scenariuszu wymagane.</p>
...
<p>ST również nie jest strategią pozbawioną wad. Nierzadką sytuacją jest błędna prognoza sprzedaży, bądź też prognoza sprzedaży zupełnie nieobecna w systemach planowania wskutek<br />
np. problemu z interfejsami pomiędzy różnymi systemami wykorzystywanymi przez przedsiębiorstwo. W takim przypadku SS ciągle generuje zapotrzebowania zapewniając określone pokrycie materiałowe, podczas gdy ST całkowicie zabija przepływ zapotrzebowań w sieci. Inną sytuacją jest np. znacząco zwiększona prognoza sprzedaży z powodu aktywności promocyjnej. Jeżeli aktywność ta trwać będzie dłuższy czas, ST znacząco przyspieszy pojawianie się zapotrzebowań w niższych ogniwach sieci,<br />
co niekoniecznie odzwierciedlać będzie moment, kiedy faktycznie muszą być wyprodukowane.</p>
...
<p><span class="chart">[CHART]</span></p>
<p><span id="_Toc503991817" class="anchor"></span>Rysunek 17 - Zestawienie zrealizowanych oraz niezrealizowanych zamówień z prognozą sprzedaży dla statycznego parametru bezpieczeństwa, Źródło: Opracowanie własne</p>
...
<p><span id="_Toc503693211" class="anchor"></span>Tabela 8 - Zestawienie wskaźników, statyczny parametr bezpieczeństwa, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
<th><strong>OFR</strong></th>
...
<p><span class="chart">[CHART]</span></p>
<p><span id="_Toc503991818" class="anchor"></span>Rysunek 18 - Wykres HIT, statyczny parametr bezpieczeństwa, Źródło: Opracowanie własne</p>
...
<p><span id="_Toc503693212" class="anchor"></span>Tabela 9 - Zestawienie wskaźników, dynamiczny parametr bezpieczeństwa, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
<th><strong>OFR</strong></th>
...
<p><span class="chart">[CHART]</span></p>
<p><span id="_Toc503991819" class="anchor"></span>Rysunek 19 - Zestawienie zrealizowanych oraz niezrealizowanych zamówień z prognozą sprzedaży dla dynamicznego parametru bezpieczeństwa, Źródło: Opracowanie własne</p>
...
<p><span class="chart">[CHART]</span></p>
<p><span id="_Toc503991820" class="anchor"></span>Rysunek 20 - Wykres HIT, dynamiczny parametr bezpieczeństwa, Źródło: Opracowanie własne</p>
...
<p>Ostatni ze scenariuszy testowych stoi nieco w opozycji do pozostałych. Scenariusze 1-3 miały na celu porównanie dwóch lub więcej przypadków, w celu określenia, jaką strategię warto przyjąć,<br />
...
<p><span id="_Toc503693213" class="anchor"></span>Tabela 10 - Zestawienie wskaźników, uszkodzenie towaru wskutek katastrofy naturalnej, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
<th><strong>OFR</strong></th>
...
<p><span id="_Toc503693214" class="anchor"></span>Tabela 11 - Zestawienie wskaźników, efekt uszkodzenia linii produkcyjnej, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
<th><strong>OFR</strong></th>
...
<ol type="1">
<li><p>W momencie uszkodzenia się linii produkcyjnej w tranzycie znajdował się towar,<br />
który doręczony został już po awarii linii</p></li>
...
<p><span class="chart">[CHART]</span></p>
<p><span id="_Toc503991822" class="anchor"></span>Rysunek 22 - Wykres HIT, efekt uszkodzenia linii produkcyjnej, Źródło: Opracowanie własne</p>
...
<p>Gdyby taka sytuacja miała miejsce w rzeczywistości, tygodniowy okres przestoju linii produkcyjnej oznaczałby znaczące skumulowanie się zapotrzebowań produkcyjnych. Wznowienie produkcji wiązałoby się z koniecznością nadania odpowiednich priorytetów wybranym produktom i węzłom w sieci, gdyż zniwelowanie tygodniowych zaległości produkcyjnych wymaga wiele czasu. Nawet w przypadku, kiedy istniałaby możliwość zwiększenia produkcji poprzez wprowadzenia dodatkowych zmian w fabryce, nie każda wymagana produkcja odbyłaby się do razu. Efekt ten nie jest jednak widoczny w stworzonej symulacji, ponieważ analizujemy sytuację, w której dokładnie w jednym ogniwie prowadzona jest sprzedaż produktów oraz dokładnie jedno ogniwo zajmuje się wytwarzaniem towaru.</p>
<p>Co więc okazuje się większym wyzwaniem dla łańcucha dostaw – tygodniowy przestój linii produkcyjnej, czy też zanik tygodniowego zapasu w centrum dystrybucyjnym? Z przeprowadzonego doświadczenia jednoznacznie wynika, że efekty zablokowania/uszkodzenia towaru są znacznie bardziej dotkliwe niż przestój linii produkcyjnej. Wiąże się to z dłuższym okresem niedostępności produktu w punkcie sprzedaży, dłuższym czasem regeneracji oraz mniejszą elastycznością w przypadku zwiększonego popytu. Podczas przestoju produkcji ciągle możliwe jest zaś utylizowanie zgromadzonych w centrum dystrybucyjnym produktów i czerpanie z zapasu bezpieczeństwa,<br />
co przekłada się na większe pokrycia materiałowe.</p>
<h1 id="podsumowanie---weryfikacja-postawionych-tez">Podsumowanie - weryfikacja postawionych tez</h1>
<h2 id="teza-1">Teza 1</h2>
<table>
<tbody>
<tr class="odd">
<td>Możliwe jest dokonanie poprawy funkcjonowania łańcucha dostaw poprzez odpowiednie skalibrowanie parametrów systemów planowania.</td>
...
<p>Przeanalizowane w tej pracy zostały dwa parametry odpowiedzialne za planowanie materiałowe:</p>
<ol type="1">
<li><p>Minimalny wolumen produkcyjny</p></li>
<li><p>Strategia replenishmentu</p></li>
</ol>
<p>W przypadku minimalnego wolumenu produkcyjnego możliwe było wykazanie bezpośredniego związku pomiędzy badanym parametrem, a wskaźnikami efektywności. Trzykrotny wzrost minimalnej partii produkcyjnej spowodował istoty spadek częstotliwości dostaw , co zaś przełożyło się na 7-procentowy spadek wolumenu zamówień, które możliwe były do zrealizowania.</p>
<p>Również i w przypadku porównywania dynamicznego i statycznego progu replenishmentu możliwy do odnotowania był znaczący wpływ strategii replenishmentu na badane wskaźniki KPI. Wykorzystując strategię ST zaobserwowano przeciętnie 33% większy zapas oraz 32% wzrostu przeciętnego pokrycia materiałowego. Umożliwiło to też uniknięcia całkowitego wyczerpania materiału, co okazało się nie do uniknięcia w przypadku strategii SS.</p>
<p>Poczynione doświadczenia oraz wyciągnięte na ich podstawie wnioski potwierdzają postawioną tezę.</p>
<h2 id="teza-2">Teza 2</h2>
<table>
<tbody>
<tr class="odd">
<td>Niska dokładność prognoz sprzedaży wprowadza do łańcucha dostaw istotne zaburzenia znacząco wpływające na KPI.</td>
...
<p>W pierwszym scenariuszu analizowane były trzy przypadki stosunku średnich zamówień do średniej prognozy sprzedaży:</p>
<ol type="1">
<li><p>Przeciętna sprzedaż zgodna z przeciętną prognozą popytu</p></li>
<li><p>Przeciętna sprzedaż niższa o 20% względem przeciętnej prognozy popytu</p></li>
<li><p>Przeciętna sprzedaż wyższa o 20% względem przeciętnej prognozy popytu</p></li>
</ol>
<p>Przeprowadzona symulacja udowodniła, że nawet pozornie niewielkie 20-procentowe odchylenia faktycznych zamówień klientów od prognozy sprzedaży znakomicie przekładają się na parametry łańcucha dostaw. Zamówienia niższe od spodziewanych przyczyniły się do 1,5-krotnego spadku rotacji, 13-krotnego podniesienia wskaźnika martwego zapasu oraz zwiększenia udziału martwego zapasu w przeciętnym zapasie – z 3% do 31%. Zamówienia wyższe od spodziewanych były odpowiedzialne za spadek poziomu obsługi klientów z 99% na 90%.</p>
<p>Poczynione doświadczenia oraz wyciągnięte na ich podstawie wnioski potwierdzają wiec tezę postawioną w rozdziale 1.3.</p>
<h2 id="teza-3">Teza 3</h2>
<table>
<tbody>
<tr class="odd">
<td>Symulacja komputerowa jest efektywnym sposobem analizowania łańcucha dostaw i umożliwia optymalizację rzeczywistych systemów.</td>
...
<p>Ostatnia z postawionych tez niemożliwa jest do zweryfikowania wyłącznie na podstawie liczb, będących wynikami przeprowadzonej symulacji. Można jej jednak dowieść dowodząc prawdziwości dwóch pozostałych tez – co zostało poczynione w rozdziałach 5.1. oraz 5.2.</p>
<p>Stworzona na potrzeby niniejszej pracy symulacja komputerowa umożliwiła przeprowadzenie badań nad czterema scenariuszami testowymi. Uzyskane wyniki pozostawały w zgodzie z zawodowym doświadczeniem autora pracy oraz nie stanowiły odstępstwa od logicznych wniosków, które można byłoby poczynić poza ramami symulacji.</p>
<p>Analizowana sieć składała się z 9 węzłów, 13 produktów oraz trwała 16 tygodni. Przeliczanie stanu ogniw sieci odbywało się co godzinę. Raz na dobę przeprowadzana była kalkulacja MRP, zaś raz na tydzień następowała aktualizacja prognozy sprzedaży. Na komputerze wyposażonym w procesor Intel Core i5 4670K oraz posiadającym 16GB pamięci RAM wykonanie jednego scenariusza testowego trwało około 3 minut 30 sekund. Głównym ograniczeniem wydajności był zaś sterownik JDBC, który uniemożliwiał wykonywanie wielu operacji bazodanowych w jednostce czasu. Ciągle jest to czas akceptowalny, a symulację uznać możemy za wydajną.</p>
<p>Architektura aplikacji pozwala na dowolne modyfikowanie artykułów i ich parametrów, węzłów sieci, a także parametrów sieci transportowej. Możliwe jest wykorzystanie dowolnych plików wejściowych z prognozą sprzedaży oraz zamówieniami klientów. Oznacza to, że wykorzystać można ją do analizowania stworzonych scenariuszy testowych dla dowolnych sieci dystrybucyjnych.</p>
<p>Fakt, że możliwe było zaimplementowanie wszystkich scenariuszy testowych, zaś sama aplikacja jest wydajna i elastyczna potwierdza ostatnią z postawionych tez.</p>
...
<p><span id="_Toc503693215" class="anchor"></span>Tabela 12 - Spis sygnatur elementów MRP, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
...
<h2 id="parametry-symulacji">Parametry symulacji</h2>
<p><span id="_Toc503693216" class="anchor"></span>Tabela 13 - Spis parametrów symulacji, Źródło: Opracowanie własne</p>
<table>
<thead>
<tr class="header">
...
<td>start_date</td>
<td>20180101</td>
<td>Data rozpoczęcia symulacji</td>
</tr>
<tr class="even">
<td>end_date</td>
<td>20180422</td>
<td>Data zakończenia symulacji</td>
</tr>
<tr class="odd">
<td>tick</td>
<td>1</td>
<td>Częstotliwość przeliczania stanu sieci wyrażona w godzinach</td>
</tr>
<tr class="even">
<td>bw_fcst_consumption</td>
<td>5</td>
<td>Maksymalna ilość dni wstecz, dla których możliwa jest konsumpcja prognozy sprzedaży</td>
</tr>
<tr class="odd">
<td>fw_fcst_consumption</td>
<td>5</td>
<td>Maksymalna ilość dni naprzód, dla których możliwa jest konsumpcja prognozy sprzedaży</td>
</tr>
<tr class="even">
<td>logging_level</td>
<td>3</td>
<td><p>Poziom logowania:</p>
<ul>
<li><p>1 – Generyczne informacje o symulacji</p></li>
<li><p>2 – Generyczne informacje o symulacji, informacje o aktualnie przeliczanych stanach ogniw</p></li>
<li><p>3 – Generyczne informacje o symulacji, informacje o aktualnie przeliczanych stanach ogniw oraz cała komunikacja pomiędzy aplikacją a serwerem bazy danych</p></li>
</ul></td>
</tr>
<tr class="odd">
<td>firmed_zone</td>
<td>3</td>
<td>Horyzont, w którym fabryka produkcyjna potwierdza możliwość realizacji produkcji wyrażony w dniach</td>
</tr>
<tr class="even">
<td>quality_check</td>
<td>4</td>
<td>Przeciętny czas trwania kontroli jakości dokonywanej po zakończeniu produkcji wyrażony w godzinach</td>
</tr>
<tr class="odd">
<td>order_leadtime</td>
<td>6</td>
<td>Horyzont, w którym po otrzymaniu zamówienia konieczne jest jego zrealizowanie wyrażony w godzinach</td>
</tr>
<tr class="even">
<td>disaster_date</td>
<td>20180223</td>
<td>Data wystąpienia katastrofy naturalnej (scenariusz 4)</td>
</tr>
<tr class="odd">
<td>breakdown_start_date</td>
<td>20180228</td>
<td>Data rozpoczęcia przestoju linii produkcyjnej<br />
(scenariusz 4)</td>
</tr>
<tr class="even">
<td>breakdown_end_date</td>
<td>20180307</td>
<td>Data zakończenia przestoju linii produkcyjnej<br />
(scenariusz 4)</td>
</tr>
</tbody>
</table>
<h2 id="tabele-w-bazie-danych">Tabele w bazie danych</h2>
<p>Tabela 14 - Spis tabeli w bazie danych, źródło: opracowanie własne</p>
<table>
<thead>
<tr class="header">
<th><strong>Nazwa tabeli</strong></th>
<th><strong>Nazwa kolumny</strong></th>
...
<td>locationfrom</td>
<td>smallint</td>
<td>Lokacja z której wysyłana jest dostawa</td>
</tr>
<tr class="odd">
<td></td>
<td>locationto</td>
<td>smallint</td>
<td>Lokacja do której wysyłana jest dostawa</td>
</tr>
<tr class="even">
<td></td>
<td>loadingdate</td>
<td>date</td>
<td>Data załadunku dostawy</td>
</tr>
<tr class="odd">
<td></td>
<td>loadingtime</td>
<td>time</td>
<td>Czas załadunku dostawy</td>
</tr>
<tr class="even">
<td></td>
<td>unloadingdate</td>
<td>date</td>
<td>Data rozładunku dostawy</td>
</tr>
<tr class="odd">
<td></td>
<td>unloadingtime</td>
<td>time</td>
<td>Czas rozładunku dostawy</td>
</tr>
<tr class="even">
<td></td>
<td>product</td>
...
<td>dlvparty</td>
<td>varchar</td>
<td>Partner realizujący dostawę</td>
</tr>
<tr class="odd">
<td>QUALITYLOT</td>
<td>qmlotnumber</td>
<td>int</td>
<td>Numer partii produkcyjnej</td>
</tr>
<tr class="even">
<td></td>
<td>location</td>
<td>smallint</td>
<td>Lokacja produkcyjna</td>
</tr>
<tr class="odd">
<td></td>
<td>releasedate</td>
<td>date</td>
<td>Data zwolnienia z kontroli jakości</td>
</tr>
<tr class="even">
<td></td>
<td>releasetime</td>
<td>time</td>
<td>Czas zwolnienia z kontroli jakości</td>
</tr>
<tr class="odd">
<td></td>
<td>product</td>
...
<td>fcstid</td>
<td>int</td>
<td>Numer prognozy sprzedaży</td>
</tr>
<tr class="even">
<td></td>
<td>location</td>
...
<td>date1</td>
<td>date</td>
<td>Data prognozowanej sprzedaży</td>
</tr>
<tr class="even">
<td></td>
<td>fcstdate</td>
<td>date</td>
<td>Data stworzenia prognozy sprzedaży</td>
</tr>
<tr class="odd">
<td>ORDERS</td>
<td>ordernumber</td>
<td>int</td>
<td>Numer zamówienia klienta</td>
</tr>
<tr class="even">
<td></td>
<td>location</td>
...
<td>loadingdate</td>
<td>date</td>
<td>Data załadunku zamówienia klienta</td>
</tr>
<tr class="odd">
<td></td>
<td>loadingtime</td>
<td>time</td>
<td>Czas załadunku zamówienia klienta</td>
</tr>
<tr class="even">
<td></td>
<td>customer</td>
...
<td>depreqnumber</td>
<td>int</td>
<td>Numer rezerwacji materiałowej</td>
</tr>
<tr class="odd">
<td></td>
<td>location</td>
...
<td>usage</td>
<td>int</td>
<td>Wielkość rezerwacji materiałowej</td>
</tr>
<tr class="odd">
<td></td>
<td>usedate</td>
<td>date</td>
<td>Data rezerwacji materiałowej</td>
</tr>
<tr class="even">
<td></td>
<td>usetime</td>
<td>time</td>
<td>Czas rezerwacji materiałowej</td>
</tr>
<tr class="odd">
<td></td>
<td>product</td>
...
<td>locationfrom</td>
<td>smallint</td>
<td>Lokalizacja dokonująca wysyłki</td>
</tr>
<tr class="odd">
<td></td>
<td>locationto</td>
<td>smallint</td>
<td>Lokalizacja odbierająca wysyłkę</td>
</tr>
<tr class="even">
<td></td>
<td>loadingdate</td>
<td>date</td>
<td>Data załadunku wysyłki</td>
</tr>
<tr class="odd">
<td></td>
<td>loadingtime</td>
<td>time</td>
<td>Czas załadunku wysyłki</td>
</tr>
<tr class="even">
<td></td>
<td>unloadingdate</td>
<td>date</td>
<td>Data rozładunku wysyłki</td>
</tr>
<tr class="odd">
<td></td>
<td>unloadingtime</td>
<td>time</td>
<td>Czas rozładunku wysyłki</td>
</tr>
<tr class="even">
<td></td>
<td>product</td>
...
<td>shipparty</td>
<td>varchar</td>
<td>Partner nadający wysyłkę</td>
</tr>
<tr class="odd">
<td>REPLENISHOUT</td>
<td>plorelnumber</td>
<td>int</td>
<td>Numer zlecenia replenishmentu</td>
</tr>
<tr class="even">
<td></td>
<td>locationfrom</td>
<td>smallint</td>
<td>Lokacja dokonująca replenishmentu</td>
</tr>
<tr class="odd">
<td></td>
<td>locationto</td>
<td>smallint</td>
<td>Lokacja odbierająca replenishment</td>
</tr>
<tr class="even">
<td></td>
<td>date</td>
<td>date</td>
<td>Data replenishmentu</td>
</tr>
<tr class="odd">
<td></td>
<td>product</td>
...
<td>locationfrom</td>
<td>smallint</td>
<td>Lokacja dostarczająca produkt</td>
</tr>
<tr class="even">
<td></td>
<td>description</td>
...
<tr class="even">
<td></td>
<td>safetystrategy</td>
<td>char</td>
<td>Strategia replenishmentu</td>
</tr>
<tr class="odd">
<td></td>
<td>target</td>
<td>int</td>
<td>Próg replenishmentu</td>
</tr>
<tr class="even">
<td></td>
<td>roundval</td>
<td>smallint</td>
<td>Wartość zaokrąglenia</td>
</tr>
<tr class="odd">
<td>PURCHASEO</td>
<td>locationfrom</td>
...
<td>idocnum</td>
<td>int</td>
<td>Numer e-dokumentu</td>
</tr>
<tr class="even">
<td></td>
<td>refnum</td>
<td>int</td>
<td>Referencja e-dokumentu</td>
</tr>
<tr class="odd">
<td>PROCESSO</td>
<td>location</td>
...
<td>prcordnumber</td>
<td>int</td>
<td>Numer zlecenia produkcji</td>
</tr>
<tr class="even">
<td></td>
<td>startdate</td>
<td>date</td>
<td>Data rozpoczęcia produkcji</td>
</tr>
<tr class="odd">
<td></td>
<td>starttime</td>
<td>time</td>
<td>Czas rozpoczęcia produkcji</td>
</tr>
<tr class="even">
<td></td>
<td>enddate</td>
<td>date</td>
<td>Data zakończenia produkcji</td>
</tr>
<tr class="odd">
<td></td>
<td>endtime</td>
<td>time</td>
<td>Czas zakończenia produkcji</td>
</tr>
<tr class="even">
<td></td>
<td>quantity</td>
...
<td>minquantity</td>
<td>int</td>
<td>Minimalna wielkość partii produkcyjnej</td>
</tr>
<tr class="odd">
<td></td>
<td>maxquantity</td>
<td>int</td>
<td>Maksymalna wielkość partii produkcyjnej</td>
</tr>
<tr class="even">
<td>SAFETIES</td>
<td>location</td>
...
<td>startloc</td>
<td>smallint</td>
<td>Początek linii transportowej</td>
</tr>
<tr class="even">
<td></td>
<td>endloc</td>
<td>smallint</td>
<td>Koniec linii transportowej</td>
</tr>
<tr class="odd">
<td></td>
<td>duration</td>
<td>smallint</td>
<td>Czas trwania transportu</td>
</tr>
<tr class="even">
<td></td>
<td>distance</td>
<td>smallint</td>
<td>Dystans transportu</td>
</tr>
<tr class="odd">
<td>LASTDOC</td>
<td>docname</td>
<td>varchar</td>
<td>Nazwa e-dokumentu</td>
</tr>
<tr class="even">
<td></td>
<td>docnumber</td>
...
<h1 id="spis-tabel">Spis tabel</h1>
<p><a href="#_Toc503693204"><span class="underline">Tabela 1 - Wykaz dodatnich elementów MRP</span> 18</a></p>
<p><a href="#_Toc503693205"><span class="underline">Tabela 2 - Wykaz ujemnych elementów MRP</span> 18</a></p>
<p><a href="#_Toc503693206"><span class="underline">Tabela 3 – Zestawienie wskaźników, zamówienia składane zgodnie z prognozą sprzedaży</span> 48</a></p>
<p><a href="#_Toc503693207"><span class="underline">Tabela 4 - Zestawienie wskaźników, zamówienia składane poniżej prognozy sprzedaży</span> 49</a></p>
<p><a href="#_Toc503693208"><span class="underline">Tabela 5 - Zestawienie wskaźników, zamówienia składane powyżej prognozy sprzedaży</span> 50</a></p>
<p><a href="#_Toc503693209"><span class="underline">Tabela 6 - Zestawienie wskaźników, niski minimalny wolumen produkcji</span> 53</a></p>
<p><a href="#_Toc503693210"><span class="underline">Tabela 7 - Zestawienie wskaźników, wysoki minimalny wolumen produkcji</span> 54</a></p>
<p><a href="#_Toc503693211"><span class="underline">Tabela 8 - Zestawienie wskaźników, statyczny parametr bezpieczeństwa</span> 58</a></p>
<p><a href="#_Toc503693212"><span class="underline">Tabela 9 - Zestawienie wskaźników, dynamiczny parametr bezpieczeństwa</span> 59</a></p>
<p><a href="#_Toc503693213"><span class="underline">Tabela 10 - Zestawienie wskaźników, uszkodzenie towaru wskutek katastrofy naturalnej</span> 62</a></p>
<p><a href="#_Toc503693214"><span class="underline">Tabela 11 - Zestawienie wskaźników, efekt uszkodzenia linii produkcyjnej</span> 63</a></p>
<p><a href="#_Toc503693215"><span class="underline">Tabela 12 - Spis sygnatur elementów MRP</span> 69</a></p>
<p><a href="#_Toc503693216"><span class="underline">Tabela 13 - Spis parametrów symulacji</span> 69</a></p>
<h1 id="spis-ilustracji">Spis ilustracji</h1>
<p><a href="#_Toc503991801"><span class="underline">Rysunek 1- Model MRP, Źródło: Opracowanie własne</span> 15</a></p>
<p><a href="#_Toc503991802"><span class="underline">Rysunek 2 - MRP Lista produktu 1, Źródło: Opracowanie własne</span> 19</a></p>
<p><a href="#_Toc503991803"><span class="underline">Rysunek 3 - MRP Lista produktu 2, Źródło: Opracowanie własne</span> 20</a></p>
<p><a href="#_Toc503991804"><span class="underline">Rysunek 4 - MRP lista produktu 3, Źródło: Opracowanie własne</span> 21</a></p>
<p><a href="#_Toc503991805"><span class="underline">Rysunek 5 - Struktura badanego łańcucha dostaw, Źródło: Opracowanie własne</span> 27</a></p>
<p><a href="#_Toc503991806"><span class="underline">Rysunek 6 - Budowa JVM, Źródło: Opracowanie własne</span> 33</a></p>
<p><a href="#_Toc503991807"><span class="underline">Rysunek 7 - Kompilacja oraz wykonywanie kodu C#, Źródło: Opracowanie własne</span> 35</a></p>
<p><a href="#_Toc503991808"><span class="underline">Rysunek 8 - Architektura aplikacj, Źródło: Opracowanie własne</span> 37</a></p>
<p><a href="#_Toc503991809"><span class="underline">Rysunek 9 - Przykładowy wykres prognozy sprzedaży oraz faktycznych wysyłek z dobową rozdzielczością Źródło: Opracowanie własne</span> 44</a></p>
<p><a href="#_Toc503991810"><span class="underline">Rysunek 10 - Przykładowy wykres prognozy sprzedaży oraz faktycznych wysyłek z tygodniową rozdzielczością Źródło: Opracowanie własne</span> 45</a></p>
<p><a href="#_Toc503991811"><span class="underline">Rysunek 11 - Shipments vs. forecast, zamówienia składane zgodnie z prognozą sprzedaży, Źródło: Opracowanie własne</span> 47</a></p>
<p><a href="#_Toc503991812"><span class="underline">Rysunek 12 – Wykres HIT, zamówienia składane zgodnie z prognozą sprzedaży, Źródło: Opracowanie własne</span> 48</a></p>
<p><a href="#_Toc503991813"><span class="underline">Rysunek 13 - Wykres HIT, zamówienia składane poniżej prognozy sprzedaży, Źródło: Opracowanie własne</span> 49</a></p>
<p><a href="#_Toc503991814"><span class="underline">Rysunek 14 - Wykres HIT, zamówienia składane powyżej prognozy sprzedaży, Źródło: Opracowanie własne</span> 51</a></p>
<p><a href="#_Toc503991815"><span class="underline">Rysunek 15 - Wykres HIT, niski minimalny wolumen produkcji, Źródło: Opracowanie własne</span> 54</a></p>
<p><a href="#_Toc503991816"><span class="underline">Rysunek 16 - Wykres HIT, wysoki minimalny wolumen produkcji, Źródło: Opracowanie własne</span> 55</a></p>
<p><a href="#_Toc503991817"><span class="underline">Rysunek 17 - Zestawienie zrealizowanych oraz niezrealizowanych zamówień z prognozą sprzedaży dla statycznego parametru bezpieczeństwa, Źródło: Opracowanie własne</span> 58</a></p>
<p><a href="#_Toc503991818"><span class="underline">Rysunek 18 - Wykres HIT, statyczny parametr bezpieczeństwa, Źródło: Opracowanie własne</span> 59</a></p>
<p><a href="#_Toc503991819"><span class="underline">Rysunek 19 - Zestawienie zrealizowanych oraz niezrealizowanych zamówień z prognozą sprzedaży dla dynamicznego parametru bezpieczeństwa, Źródło: Opracowanie własne</span> 60</a></p>
<p><a href="#_Toc503991820"><span class="underline">Rysunek 20 - Wykres HIT, dynamiczny parametr bezpieczeństwa, Źródło: Opracowanie własne</span> 60</a></p>
<p><a href="#_Toc503991821"><span class="underline">Rysunek 21 - Wykres HIT, uszkodzenie towaru wskutek katastrofy naturalnej, Źródło: Opracowanie własne</span> 63</a></p>
<p><a href="#_Toc503991822"><span class="underline">Rysunek 22 - Wykres HIT, efekt uszkodzenia linii produkcyjnej, Źródło: Opracowanie własne</span> 64</a></p>
...
<li id="fn37"><p>HIT – Historical Inventory Tracking, zapis stanu zapasu oraz parametrów bezpieczeństwa<br />
w perspektywie czasu<a href="#fnref37" class="footnote-back">↩</a></p></li>
